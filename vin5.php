...
echo "\e[96m___________\e[95m".date('[d-m-Y] [H:i:s]')."\e[96m_____________\n";
echo "\e[95m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬\n";
echo "\e[96m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬\n";
echo "\e[93m       \e[96m		JAGAN DIJUAL!!!		\e[93m \n";
echo "\e[93m      \e[96m		PRIVATE 			\e[93m \n";
echo "\e[96m  ==============================================\n";
echo "\e[96m  =\e[95m 🤸  1. VOUCHER 1 ✓🇮🇩 \e[96m=\n";
echo "\e[96m  =\e[95m 🤸  2. VOUCHER 2 ✓🇮🇩 \e[96m=\n";
echo "\e[96m  =\e[95m 🤸  3. VOUCHER 3 ✓🇮🇩 \e[96m=\n";
echo "\e[96m  =\e[95m 🤸  4. VOUCHER 4 ✓🇮🇩 \e[96m=\n";
echo "\e[96m  ==============================================\n";
echo "\e[96m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬\n";
echo "\e[95m Sudah Punya User Id ENTER SAJA ";	
...
// function change(){
	 ...
	 reff:
        ...
        $code1 = request('/go-promotions/v1/promotions/enrollments', $token, '{"promo_code":"GOJEKPEDULI"}');
        ...
        $code1 = request('/go-promotions/v1/promotions/enrollments', $token, '{"promo_code":"HEMAT"}');
        $message = fetch_value($code1,'"message":"','"');
        if(strpos($code1, 'Promo kamu sudah bisa dipakai.')){
        echo "\n".color("green","🔓▶️ Message: ".$message);
        goto gofood;
	...
	for($a=1;$a<=3;$a++){
        ...
        $TOKEN  = "1032900146:AAE7V93cvCvw1DNuTk0Hp1ZFywJGmjiP7aQ";
         ...
         echo color("nevy","▬▬▬▬▬▬▬▬▬▬▬▬▬▬🔧 PIN GOPAY KAMU ADALAH = 113335 🔧▬▬▬▬▬▬▬▬▬▬▬▬")."\n";
         $data2 = '{"pin":"113335"}';
